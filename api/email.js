...
// Mirrors the fallback logic in /api/suggest-subject — both kept short,
// declarative, and gift-framed ("a letter") rather than transactional
// ("a personal note"). The period at the end is deliberate; it reads as
// a single statement, not a clickbait open.
...
export default async function handler(req, res) {
  ...
  // but the live send path leaves it empty so recipients click through
  // without a peek of the letter's content first.
